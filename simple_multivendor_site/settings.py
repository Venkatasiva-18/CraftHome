...
# STRIPE PAYMENT
STRIPE_PUB_KEY = os.getenv('STRIPE_PUB_KEY' )# For JavaScript
STRIPE_SECRET_KEY = os.getenv('STRIPE_SECRET_KEY') # For Django Backend

# For Email Notification
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_HOST_USER = 'venkatasivaragala@gmail.com'
